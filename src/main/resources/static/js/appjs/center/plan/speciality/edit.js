...
function update() {
	...
	$.ajax({
		cache : true,
		type : "get",
		url :contextPath+  "/common/searchIfExist?tableName=pla_speciality&method=update&updateKey=id&updateKeyValue="+$("#id").val()+"&filedName1=id&filedValue1="+$("#id").val()+"&filedName2=name&filedValue2="+$("#name").val(),// 你的formid
		async : false,
		...
		success : function(data) {
			  if (data > 0) {
				...
				$.ajax({
					cache : true,
					type : "POST",
					url :contextPath+ "/plan/speciality/update",
