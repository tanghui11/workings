...
var prefix =contextPath+ "/plan/courseCheck"
								...
								},*/
								{
									...
									formatter : function(value, row, index) {
										...
										var g = '<a class="btn btn-success btn-sm"'+'style="margin-right:5px"'
											+ '" href="'+contextPath+'/plan/courseCheckItem/?id='+row.id+"&name="+row.name
											+ '" data-index="examRegOrg"'
											+ ' data-text="'+row.name+'添加课程"'
											+ ' data-refresh="true"'
											+ ' onclick="parent.menuItem(this);return false;s"'
											+ ' data-id="examRegOrg">添加课程</a>';
										return e + d +g;
									}
