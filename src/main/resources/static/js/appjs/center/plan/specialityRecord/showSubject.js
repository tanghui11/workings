                ...
                columns : [
                   ...
                   /*  {
                    ...
                    },
                    {
						...
						if(panduanId=="1"){
							 parent.$("#gradSpecialityid").val(row.id);
							 parent.$("#specialityName").val(row.subjectName+row.direction);
						}else if(panduanId=="2"){
							 parent.$("#specialityRecordid").val(row.id);
							 parent.$("#specialityRecordName").val(row.subjectName+"("+row.direction+")");
						}else{ 
                                parent.$("#subjectName").val(row.subjectName+"("+row.direction+")");
                                parent.$("#specialityid").val(row.id);
                                parent.$("#specialityRecordid").val(row.id);
                                  parent.$("#specialityRecordName").val(row.subjectName+"("+row.direction+")");
                                parent.$("#gradSpecialityid").val(row.specialityid);
                                parent.$("#specialityName").val(row.subjectName+"("+row.direction+")");
						}
