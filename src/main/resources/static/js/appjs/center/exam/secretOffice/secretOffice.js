...
var prefix =contextPath+ "/exam/secretOffice"
$(function() {
	load();
	kSrw();
});
						...
						columns : [
								{
									...
									width : '50px',
									formatter : function(value, row, index) {
										var e = '<a class="btn btn-primary btn-sm '+s_edit_h+'" href="#" mce_href="#" title="查看信息" onclick="edit(\''
												+ row.id
