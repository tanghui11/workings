  ...
  $("#target").delegate(".component", "click", function(e){
    ...
    $.each(valtypes, function(i,e){
      ...
      if(valID ==="#placeholder"){
        ...
        val2 = $(e).attr("onchange");//new......huoqu
        val3 = $(e).attr("onload");//new......huoqu
		val4 = $(e).attr("onclick");//new......huoqu
		val5 = $(e).attr("name");//new......huoqu
		val6 = $(e).attr("id");//new......huoqu
		val7 = $(e).attr("onfocus");//new......huoqu
        $(".popover " + valID).val(val);
        $(".popover #onchange").val(val2);//new......huoqu
        $(".popover #onload").val(val3);//new......huoqu
		$(".popover #onclick").val(val4);//new......huoqu
		$(".popover #nameV").val(val5);//new......huoqu
		$(".popover #idV").val(val6);//new......huoqu
		$(".popover #onfocus").val(val7);//new......huoqu
    ...
    $(".popover").delegate(".btn-info", "click", function(e){
      ...
      if(vartype==="placeholder"){
      ...
      }	else if (vartype==="onchange"){
        	var onCV = $("#onchange").val();//new......chuangjian
        	var onCV2 = $("#onload").val();//new......chuangjian
			var onCV3 = $("#onclick").val();//new......chuangjian
			var onCV4 = $("#nameV").val();//new......chuangjian
			var onCV5 = $("#idV").val();//new......chuangjian
			var onCV6 = $("#onfocus").val();//new......chuangjian
          $active_component.find('[data-valtype=placeholder]').attr("onchange", onCV);//new......chuangjian
          $active_component.find('[data-valtype=placeholder]').attr("onload", onCV2);//new......chuangjian
		  $active_component.find('[data-valtype=placeholder]').attr("onclick", onCV3);//new......chuangjian
		  $active_component.find('[data-valtype=placeholder]').attr("name", onCV4);//new......chuangjian
		  $active_component.find('[data-valtype=placeholder]').attr("id", onCV5);//new......chuangjian
		  $active_component.find('[data-valtype=placeholder]').attr("onfocus", onCV6);//new......chuangjian
       } 
		...
		var onCV4 = $("#nameV").val();//new......chuangjian
		var onCV5 = $("#idV").val();//new......chuangjian
	    $active_component.find('[data-valtype=option]').attr("onchange", onCV);//new......chuangjian
	    $active_component.find('[data-valtype=option]').attr("onload", onCV2);//new......chuangjian
		$active_component.find('[data-valtype=option]').attr("onclick", onCV3);//new......chuangjian
		$active_component.find('[data-valtype=option]').attr("name", onCV4);//new......chuangjian
		$active_component.find('[data-valtype=option]').attr("id", onCV5);//new......chuangjian
		...
		var onCV = $("#onchange").val();//new......chuangjian
	    var onCV2 = $("#onload").val();//new......chuangjian
	    $active_component.find('[data-valtype=inline-checkboxes]').attr("onchange", onCV);//new......chuangjian
	    $active_component.find('[data-valtype=inline-checkboxes]').attr("onload", onCV2);//new......chuangjian
        $(value).append("\n  ")
