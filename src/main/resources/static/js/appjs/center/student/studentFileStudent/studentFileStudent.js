...
function yemian(){
	layer.open({
		...
		shadeClose : false, 
		area : [ '90%', '90%' ],
		content : contextPath+"student/studentFile/showSubject"
	});
} 
function load() {
	$('#exampleTable')
					...
					//	showColumns : true,
						...
						queryParams : function(params) {
							return {
								...
								schoolSpecialityRegid:$('#schoolSpecialityRegid').val()
							};
						},
...
function jihua(){
	if($("#serachName").val()==""){
		...
		layer.open({
			...
			shadeClose : false, 
			area : [ '800px', '520px' ],
			content : contextPath + 'student/studentFile/schoolSpecialityReg'
		});
	}
}
