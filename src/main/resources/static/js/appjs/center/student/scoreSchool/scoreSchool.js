...
var prefix =contextPath+  "/student/scoreSchool"
$(function() {
	load();
    loadTree();
    //计算机构树div高度
						...
						columns : [
								{
									...
									title : '专业课程',
								formatter: function (value, row, index) {
									return row.courseid+" "+row.courseName;
								}
								},
										{
									field : 'grade', 
...
$('#jstree').on("changed.jstree", function (e, data) {
	console.info(data.node.original.text)
	console.info()
    if (data.selected == -1) {

    } else {
		code=data.node.original.text.substr(0,4)
        reLoad();
    }
});