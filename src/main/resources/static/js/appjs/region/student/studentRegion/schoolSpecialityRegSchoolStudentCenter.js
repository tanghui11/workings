        ...
        .bootstrapTable(
            {
                ...
                onCheck: function (row) {
                    ...
                    parent.$("#schoolSpecialityRegid").val("(" + row.specialityid + ")" + row.specialityName);
                    parent.$("#specialityRecordid2").val(row.schoolSpecialityRegid);
