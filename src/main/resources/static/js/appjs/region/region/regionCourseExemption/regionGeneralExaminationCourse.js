...
$(function() {
	...
	var specialityRecordid = url.split("?")[1].split("&")[0].split("=")[1];
									...
									width : '200px',
                                            formatter : function(value, row, index) {
                                                ...
                                                var f = '<a class="btn btn-success btn-sm"'
                                                    ...
                                                    + '" href="'+contextPath+'region/exemptionCourseReplace?studentid='+$("#studentid").val()+'&specialityRecordid='+$("#specialityRecordid").val()+'&courseid='+row.courseid
                                                    + '" data-index="examRegOra"' 
                                                    + ' data-text="课程顶替"'
                                                    + ' data-refresh="true"'
                                                    + ' onclick="parent.menuItem(this);return false;"'
                                                    + ' data-id="examRegOra">课程顶替</a>';
                                                return f;
                                            }
								} ],
