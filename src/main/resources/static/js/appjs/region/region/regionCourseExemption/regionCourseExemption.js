...
var prefix =contextPath+ "region/regionCourseExemption"
$(function() {
	load();
});
var code;
								...
								},
								{
									...
									formatter : function(value, row, index) {
                                        var f = '<a class="btn btn-success btn-sm"'
                                            ...
                                            + '" href="'+contextPath+'region/regionGeneralExaminationCourse?specialityRecordid='+row.specialityRecordid+'&studentid='+row.studentid
