...
var prefix = contextPath+"/school/teachSiteSchool"
$(function() {
	loadTree();
	load();
	//计算机构树div高度
					...
					//	showColumns : true,
						...
						queryParams : function(params) {
							return {
								...
								name:$('#searchName').val(),
								linkman:$('#searchLinkman').val(),
								schoolSiteName:$('#schoolSiteName').val(),
								collegeid:$('#orgid').val(),
...
function getTreeData() {
    $.ajax({
        type: "GET",
        url: contextPath+"/common/tree/collegeTree",
    ...
    $("#jstree").jstree({
        'core': {
            "data" : {
                ...
                "url" : function(node){
                    return contextPath+'/common/tree/collegeTree';
                },
                "data" : function(node){
                    if(node.id !="#"){
