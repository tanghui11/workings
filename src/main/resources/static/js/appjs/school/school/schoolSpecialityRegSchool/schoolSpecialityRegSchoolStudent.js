        ...
        .bootstrapTable(
            {
                ...
                onCheck:function(row){
                    ...
                    parent.$("#schoolSpecialityRegid2").val(row.id);
                    parent.$("#specialityRecordid").val(row.specialityRecordid)
                    parent.$("#specialityName").val(row.specialityId+row.specialityName)
                    parent.$("#specialityRecordName").val(row.specialityId+row.specialityName)
                    parent.$("#classifyName").val(row.classify)
                    parent.$("#typeName").val(row.type+"/"+row.method)
                    parent.$("#educateLengthName").val(row.educateLength)
                    parent.$("#schoolName2").val(row.schoolName)
                    parent.$("#regYearSeaSon").val(row.regYear+row.regSeason)
                },
