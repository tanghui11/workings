...
var prefix = contextPath + "/school/studentInMigration"
$(function() {
	load();
});
    ...
    layer.confirm("确认要调档选中的'" + rows.length + "'条数据吗?", {
        ...
        $.ajax({
            ...
            data : {
                "id" : id,
				"studentid":$("#searchstudentid").val(),
				"certificate":$("#searchCertificate").val()
            },
...
function studentScoreIn(id) {
    ...
    layer.open({
        ...
        area: ['80%', '80%'],
        content: contextPath + 'school/studentScoreInMigration?studentInid='+id // iframe的url
    });
