        ...
        .bootstrapTable(
            {
                ...
                queryParams : function(params) {
                    return {
                        ...
                        code:$('#searchCode').val(),
                        specialityRecordid:$('#specialityCode').val(),
                        auditStatus:"b"
                ...
                onCheck:function(row){
                    ...
                    parent.$("#specialityZYid").val(row.id);
                    parent.$("#schoolSpecialityRegid").val("("+row.specialityCode+")"+row.specialityName)
                    parent.$("#specialityRecordName").val("("+row.specialityCode+")"+row.specialityName)
                    parent.$("#schoolSpecialityRegid2").val(row.specialityCode)
