...
$(function() {
	...
	for(var i=0;i<3;i++){
		var options = "<option value="+(year-i)+">"+(year-i)+"</option>"
		$("#searchRegYear").append(options)
	}
});
			...
			.bootstrapTable(
					...
					//	showColumns : true,
						...
						onCheck:function(row){
							...
							var data = row.specialityId+row.specialityName+"["+row.regYear+" "+row.regSeason+"]"
							parent.$("#sourceRegid").val(data);
							parent.$("#sourceRegid2").val(row.id);
						},
