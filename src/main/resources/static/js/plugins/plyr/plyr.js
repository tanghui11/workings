...
(function (api) {
    ...
    var defaults = {
        ...
        selectors: {
            ...
            buttons: {
                ...
                volume: '[data-player="paperVolume"]',
    ...
    function _buildControls() {
        ...
        if (_inArray(config.controls, 'mute')) {
            html.push(
                ...
                '<svg><use xlink:href="#' + config.iconPrefix + '-paperVolume" /></svg>',
        ...
        if (_inArray(config.controls, 'volume')) {
            html.push(
                '<label for="paperVolume{id}" class="sr-only">' + config.i18n.volume + '</label>',
                '<input id="paperVolume{id}" class="player-paperVolume" type="range" min="0" max="10" value="5" data-player="paperVolume">'
            );
        }
    ...
    function Plyr(container) {
        ...
        // Update paperVolume UI and storage
        function _updateVolume() {
            // Get the current paperVolume
            ...
            // Store the paperVolume in storage
            if (config.storage.enabled && _storage().supported) {
