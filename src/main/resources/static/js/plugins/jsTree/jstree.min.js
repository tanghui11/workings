 ...
 */
    ...
    $.jstree.defaults.contextmenu = {
        select_node: true, show_at_node: true, items: function (o, cb) {
            return {
                ...
                //             }, "separator_after": false, "label": "复制", "action": function (data) {
                //                 var inst = $.jstree.reference(data.reference), obj = inst.get_node(data.reference);
                //                 inst.paste(obj)
                //             }
                //         }
    ...
    $(function () {
        ...
        $(document).on("dnd_start.vakata.jstree", function (e, data) {
            ...
            lastev = false;
            data.helper.css("color","red")
            data.helper.find(".jstree-icon").first().removeClass("jstree-ok").addClass("jstree-er").css("color")
