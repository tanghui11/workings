    ...
    public void run() {
        ...
        try {
           if (enabled.equals("true")) {
               SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");   System.out.println(value+":开始,"+list.size()+df.format(System.currentTimeMillis()));
            ...
            SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");   System.out.println(value+":结束"+df.format(System.currentTimeMillis()));
