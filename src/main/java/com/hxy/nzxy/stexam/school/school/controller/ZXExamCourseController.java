...
@Controller
@RequestMapping("/school/examCourse")
public class ZXExamCourseController extends SystemBaseController{
	@Autowired
	...
	@GetMapping()
	@RequiresPermissions("school:examCourse:examCourse")
	String ExamCourse(Model model){
	    ...
	    return "school/school/examCourse/examCourse";
	}
	...
	@GetMapping("/add")
	@RequiresPermissions("school:examCourse:add")
	String add(Model model){
		model.addAttribute("exa_exam_course_type", commonService.listFieldDict(getAppName(), "exa_exam_course", "type"));
		model.addAttribute("exa_exam_course_classify", commonService.listFieldDict(getAppName(), "exa_exam_course", "classify"));
		model.addAttribute("exa_exam_course_card_type", commonService.listFieldDict(getAppName(), "exa_exam_course", "card_type"));

		return "school/school/examCourse/add";
	}

	@GetMapping("/edit/{id}")
	@RequiresPermissions("school:examCourse:edit")
	String edit(@PathVariable("id") Long id,Model model){
		...
		return "school/school/examCourse/edit";
	}
	...
	@PostMapping( "/remove")
	@ResponseBody
	@RequiresPermissions("school:examCourse:remove")
	...
	@ResponseBody
	@RequiresPermissions("SCHOOL:examCourse:batchRemove")
	...
	public String searchOutEXcel(@RequestParam Map<String, Object> params, HttpServletResponse response, HttpServletRequest request, Model model) {
		...
		if (examCourseList != null && examCourseList.size() > 0) {
			...
			model.addAttribute("exa_exam_course_type", commonService.listFieldDict(getAppName(), "exa_exam_course", "type"));
			model.addAttribute("exa_exam_course_classify", commonService.listFieldDict(getAppName(), "exa_exam_course", "classify"));
			model.addAttribute("exa_exam_course_card_type", commonService.listFieldDict(getAppName(), "exa_exam_course", "card_type"));model.addAttribute("exa_exam_course_type", commonService.listFieldDict(getAppName(), "exa_exam_course", "type"));
			model.addAttribute("exa_exam_course_classify", commonService.listFieldDict(getAppName(), "exa_exam_course", "classify"));
			model.addAttribute("exa_exam_course_card_type", commonService.listFieldDict(getAppName(), "exa_exam_course", "card_type"));
			return "school/school/examCourse/examCourse";
		}
