...
import com.hxy.nzxy.stexam.common.service.GeneratorService;
import com.hxy.nzxy.stexam.common.utils.R;
import com.hxy.nzxy.stexam.common.service.GeneratorService;
import com.hxy.nzxy.stexam.common.utils.GenUtils;
import com.hxy.nzxy.stexam.common.utils.R;
import com.hxy.nzxy.stexam.common.service.GeneratorService;
import com.hxy.nzxy.stexam.common.utils.GenUtils;
import com.hxy.nzxy.stexam.common.utils.R;
...
public class GeneratorController {
	...
	public void code(HttpServletRequest request, HttpServletResponse response,
		...
		response.reset();
		response.setHeader("Content-Disposition", "attachment; filename=\"summernoteUrl.zip\"");
	...
	public void batchCode(HttpServletRequest request, HttpServletResponse response, String tables) throws IOException {
		...
		byte[] data = generatorService.generatorCode(tableNames);
		response.reset();
		response.setHeader("Content-Disposition", "attachment; filename=\"stexam.zip\"");
		response.addHeader("Content-Length", "" + data.length);
		response.setContentType("application/octet-stream; charset=UTF-8");
	...
	public String edit(Model model) {
		...
		property.put("package1", conf.getProperty("package1"));
    ...
    R update(@RequestParam Map<String, Object> map) {
		try {
			...
			conf.setProperty("package1", map.get("package1"));
